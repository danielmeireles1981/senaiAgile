"""
Django settings for SENAIAgile project.
...
SECRET_KEY = 'django-insecure-ag@$d3zc9^))h_4aq*k10n=@6f7&wkd$f8we&q(6=htujsyqy#'
...
WSGI_APPLICATION = 'SENAIAgile.wsgi.application'
